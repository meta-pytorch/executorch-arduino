...
inline const char *EnumNameDeviceType(DeviceType e) {
  if (::flatbuffers::IsOutRange(e, DeviceType::CPU, DeviceType::CUDA)) return "";
  const size_t index = static_cast<size_t>(e);
...
struct ExtraTensorInfo FLATBUFFERS_FINAL_CLASS : private ::flatbuffers::Table {
  ...
  executorch_flatbuffer::DeviceType device_type() const {
    return static_cast<executorch_flatbuffer::DeviceType>(GetField<int8_t>(VT_DEVICE_TYPE, 0));
  }
  bool mutate_device_type(executorch_flatbuffer::DeviceType _device_type = static_cast<executorch_flatbuffer::DeviceType>(0)) {
  ...
  bool mutate_device_index(int8_t _device_index = 0) {
    return SetField<int8_t>(VT_DEVICE_INDEX, _device_index, 0);
  }
  bool Verify(::flatbuffers::Verifier &verifier) const {
    return VerifyTableStart(verifier) &&
...
struct ExtraTensorInfoBuilder {
  ...
  void add_device_type(executorch_flatbuffer::DeviceType device_type) {
    fbb_.AddElement<int8_t>(ExtraTensorInfo::VT_DEVICE_TYPE, static_cast<int8_t>(device_type), 0);
  }
  void add_device_index(int8_t device_index) {
    fbb_.AddElement<int8_t>(ExtraTensorInfo::VT_DEVICE_INDEX, device_index, 0);
  }
...
inline ::flatbuffers::Offset<ExtraTensorInfo> CreateExtraTensorInfo(
    ...
    executorch_flatbuffer::DeviceType device_type = executorch_flatbuffer::DeviceType::CPU,
...
struct ExecutionPlan FLATBUFFERS_FINAL_CLASS : private ::flatbuffers::Table {
  ...
  const ::flatbuffers::Vector<::flatbuffers::Offset<executorch_flatbuffer::NonConstBufferDevice>> *non_const_buffer_device() const {
    return GetPointer<const ::flatbuffers::Vector<::flatbuffers::Offset<executorch_flatbuffer::NonConstBufferDevice>> *>(VT_NON_CONST_BUFFER_DEVICE);
  }
  ::flatbuffers::Vector<::flatbuffers::Offset<executorch_flatbuffer::NonConstBufferDevice>> *mutable_non_const_buffer_device() {
    return GetPointer<::flatbuffers::Vector<::flatbuffers::Offset<executorch_flatbuffer::NonConstBufferDevice>> *>(VT_NON_CONST_BUFFER_DEVICE);
  }
  bool Verify(::flatbuffers::Verifier &verifier) const {
    return VerifyTableStart(verifier) &&
           VerifyOffset(verifier, VT_NAME) &&
           ...
           VerifyOffset(verifier, VT_NON_CONST_BUFFER_DEVICE) &&
           verifier.VerifyVector(non_const_buffer_device()) &&
           verifier.VerifyVectorOfTables(non_const_buffer_device()) &&
           verifier.EndTable();
  }
};
...
struct ExecutionPlanBuilder {
  ...
  void add_non_const_buffer_device(::flatbuffers::Offset<::flatbuffers::Vector<::flatbuffers::Offset<executorch_flatbuffer::NonConstBufferDevice>>> non_const_buffer_device) {
    fbb_.AddOffset(ExecutionPlan::VT_NON_CONST_BUFFER_DEVICE, non_const_buffer_device);
  }
...
inline ::flatbuffers::Offset<ExecutionPlan> CreateExecutionPlan(
    ...
    ::flatbuffers::Offset<::flatbuffers::Vector<::flatbuffers::Offset<executorch_flatbuffer::NonConstBufferDevice>>> non_const_buffer_device = 0) {
  ExecutionPlanBuilder builder_(_fbb);
  builder_.add_non_const_buffer_device(non_const_buffer_device);
...
inline ::flatbuffers::Offset<ExecutionPlan> CreateExecutionPlanDirect(
    ...
    const std::vector<::flatbuffers::Offset<executorch_flatbuffer::NonConstBufferDevice>> *non_const_buffer_device = nullptr) {
  auto name__ = name ? _fbb.CreateString(name) : 0;
  ...
  auto non_const_buffer_device__ = non_const_buffer_device ? _fbb.CreateVector<::flatbuffers::Offset<executorch_flatbuffer::NonConstBufferDevice>>(*non_const_buffer_device) : 0;
  return executorch_flatbuffer::CreateExecutionPlan(
      ...
      non_const_buffer_device__);
}

struct NonConstBufferDevice FLATBUFFERS_FINAL_CLASS : private ::flatbuffers::Table {
  typedef NonConstBufferDeviceBuilder Builder;
  enum FlatBuffersVTableOffset FLATBUFFERS_VTABLE_UNDERLYING_TYPE {
    VT_BUFFER_IDX = 4,
    VT_DEVICE_TYPE = 6,
    VT_DEVICE_INDEX = 8
  };
  int32_t buffer_idx() const {
    return GetField<int32_t>(VT_BUFFER_IDX, 0);
  }
  bool mutate_buffer_idx(int32_t _buffer_idx = 0) {
    return SetField<int32_t>(VT_BUFFER_IDX, _buffer_idx, 0);
  }
  executorch_flatbuffer::DeviceType device_type() const {
    return static_cast<executorch_flatbuffer::DeviceType>(GetField<int8_t>(VT_DEVICE_TYPE, 0));
  }
  ...
  bool Verify(::flatbuffers::Verifier &verifier) const {
    return VerifyTableStart(verifier) &&
           VerifyField<int32_t>(verifier, VT_BUFFER_IDX, 4) &&
           VerifyField<int8_t>(verifier, VT_DEVICE_TYPE, 1) &&
           VerifyField<int8_t>(verifier, VT_DEVICE_INDEX, 1) &&
           verifier.EndTable();
  }
...
struct NonConstBufferDeviceBuilder {
  typedef NonConstBufferDevice Table;
  ::flatbuffers::FlatBufferBuilder &fbb_;
  ::flatbuffers::uoffset_t start_;
  void add_buffer_idx(int32_t buffer_idx) {
    fbb_.AddElement<int32_t>(NonConstBufferDevice::VT_BUFFER_IDX, buffer_idx, 0);
  }
  void add_device_type(executorch_flatbuffer::DeviceType device_type) {
    fbb_.AddElement<int8_t>(NonConstBufferDevice::VT_DEVICE_TYPE, static_cast<int8_t>(device_type), 0);
  }
  void add_device_index(int8_t device_index) {
    fbb_.AddElement<int8_t>(NonConstBufferDevice::VT_DEVICE_INDEX, device_index, 0);
  }
  explicit NonConstBufferDeviceBuilder(::flatbuffers::FlatBufferBuilder &_fbb)
        : fbb_(_fbb) {
    start_ = fbb_.StartTable();
  }
  ::flatbuffers::Offset<NonConstBufferDevice> Finish() {
    const auto end = fbb_.EndTable(start_);
    auto o = ::flatbuffers::Offset<NonConstBufferDevice>(end);
    return o;
  }
};

inline ::flatbuffers::Offset<NonConstBufferDevice> CreateNonConstBufferDevice(
    ::flatbuffers::FlatBufferBuilder &_fbb,
    int32_t buffer_idx = 0,
    executorch_flatbuffer::DeviceType device_type = executorch_flatbuffer::DeviceType::CPU,
    int8_t device_index = 0) {
  NonConstBufferDeviceBuilder builder_(_fbb);
